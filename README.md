...
- Gradle
```
implementation("io.github.devzwy:mdhelper:2.1.1")
```
 ...
 */
fun createTable(appName: String? = null, tableName: String, tableAlias: String? = null, vararg filed: CreateTableData)
```
